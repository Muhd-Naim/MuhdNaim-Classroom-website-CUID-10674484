    ...
    <body>
        <div class="banner">
            ...
            <div class="content">
                ...
                <p>Ask questions, Design your times table and make new friends.<br>You can ask any question to help youself better in your study. This will help you future. </p>
                <div class="homepagebut">
                    <a href="register.php"> 
                        <button type="button"><span></span>REGISTER NOW</button>
                    </a>
                    <a href="tutorial_out.php">
